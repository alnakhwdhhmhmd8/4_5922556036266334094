...
#< https://t.me/ZThon >
# This file is a part of < https://github.com/Zed-Thon/CU_FGal/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/Zed-Thon/CU_FGal/blob/master/LICENSE/>.
...
LOGS = logging.getLogger("CU_FG")
cmdhr = Config.COMMAND_HAND_LER
Zed_Vip = (7157276873, 7157276873, 7157276873, 7157276873, 7157276873, 7157276873, 7157276873, 7157276873, 7157276873)
Zed_Dev = (7157276873, 7157276873, 7157276873, 7157276873, 7157276873, 7157276873, 7157276873, 7157276873)
zchannel = {"@CU_FG", "@Tws_CU_FG", "@CU_FGe1", "@CU_FGHelp", "@VVV5P", "@PPYNY"}
...
async def mybot(): #Code by T.me/zzzzl1l
    ...
    if bot_name.startswith("مسـاعـد"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", "CU_FG")
            ...
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_file("@BotFather", "CU_FG/zilzal/logozed.jpg")
            await asyncio.sleep(3)
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                buttons=[(Button.url("𝐬𝐨𝐮𝐫𝐜𝐞 ᴊᴀᴋ 🇵🇸", "https://t.me/CU_FG"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/CU_FG.jpg")
